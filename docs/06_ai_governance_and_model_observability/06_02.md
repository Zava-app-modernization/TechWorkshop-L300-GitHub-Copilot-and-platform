...
Use GitHub Copilot Chat to update your Bicep templates to enable diagnostic settings for the Azure AI Foundry workspace, sending all logs to your Log Analytics workspace.
...
> **NOTE** Diagnostic logs for Azure AI Foundry may take 2–10 minutes to appear in Log Analytics. This is normal. If nothing appears immediately, wait a few minutes and run the query again.
