...
1. Open VS Code → GitHub Copilot Chat, then paste the following prompt:
...
2. Review Copilot's changes and ensure it:
...
3. Deploy the updated code using the following command:
